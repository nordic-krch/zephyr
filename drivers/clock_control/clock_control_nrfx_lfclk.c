...
#define DT_DRV_COMPAT nordic_nrfx_clock_lfclk

#define CLOCK_DEVICE_LFCLK DEVICE_DT_GET_ONE(nordic_nrfx_clock_lfclk)

#if NRF_CLOCK_HAS_HFCLK
#define CLOCK_DEVICE_HF DEVICE_DT_GET_ONE(nordic_nrfx_clock_hfclk)
#else /* NRF_CLOCK_HAS_XO */
#define CLOCK_DEVICE_HF DEVICE_DT_GET_ONE(nordic_nrfx_clock_xo)
#endif
