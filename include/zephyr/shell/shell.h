...
#define SHELL_CMD_FLAG_REMOTE_MASK (SHELL_CMD_FLAG_REMOTE_ROOT | SHELL_CMD_FLAG_REMOTE_SUBCMD)
...
#define SHELL_EXPR_CMD_ARG(_expr, _syntax, _subcmd, _help, _handler, \
	...
	{ \
		...
		.args = { .mandatory = _mand, .optional = _opt, \
			.ipc_cmd = _ipc_cmd, .ipc_id = _ipc_id } \
	}
...
#define shell_fprintf_info(sh, fmt, ...) shell_fprintf(sh, SHELL_INFO, fmt, ##__VA_ARGS__)
...
#define shell_fprintf_normal(sh, fmt, ...) shell_fprintf(sh, SHELL_NORMAL, fmt, ##__VA_ARGS__)
...
#define shell_fprintf_warn(sh, fmt, ...) shell_fprintf(sh, SHELL_WARNING, fmt, ##__VA_ARGS__)
...
#define shell_fprintf_error(sh, fmt, ...) shell_fprintf(sh, SHELL_ERROR, fmt, ##__VA_ARGS__)
