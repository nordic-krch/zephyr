...
/* PPIB133 ch. 5 => PPIB130 ch. 8+5 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f99d000UL, 5);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f925000UL, 8+5);
/* PPIB133 ch. 6 => PPIB130 ch. 8+6 */
UICR_PPIB_SUBSCRIBE_SEND_ENABLE(0x5f99d000UL, 6);
UICR_PPIB_PUBLISH_RECEIVE_ENABLE(0x5f925000UL, 8+6);
