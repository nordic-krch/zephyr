...
static const struct device_data devices[] = {
#if NRF_CLOCK_HAS_HFCLK
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_hfclk),
...
#if NRF_CLOCK_HAS_XO
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_xo),
	 ...
	 */
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_lfclk),
...
#if NRF_CLOCK_HAS_HFCLK192M
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_hfclk192m),
...
#if NRF_CLOCK_HAS_HFCLKAUDIO
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_hfclkaudio),
...
#if NRF_CLOCK_HAS_XO24M
	{
		.dev = DEVICE_DT_GET_ONE(nordic_nrfx_clock_xo24m),
