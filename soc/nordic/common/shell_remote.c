...
/* shell_remote_ppr/flpr/radio is the endpoint name used by the IPC service. Same name must be
 * used by the client by setting CONFIG_SHELL_REMOTE_CLI_EP_NAME.
 */
